...
needed_packages <- c("readxl", "ggplot2", "dplyr", "semTools", "FSA", "car", "effectsize", "userfriendlyscience", "rstatix", "sjstats", "gmodels","stargazer","lm.beta","foreign","olsrr", "psych",  "REdaS", "Hmisc", "corrplot", "ggcorrplot", "factoextra",  "nFactors", "HDclassif")                                    
